...
class OpenWeatherForecastProviderAdapter(private val openWeatherApi: OpenWeatherApi, private val mapper: OpenWeatherForecastProviderMapper, private val logger: Logger) : ForecastProvider {
